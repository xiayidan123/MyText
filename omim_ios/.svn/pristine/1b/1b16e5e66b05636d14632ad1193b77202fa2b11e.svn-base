...
@implementation Communicator_GetBuddyList
...
- (void)wowtalkXMLParseFinished:(NSMutableDictionary *)result
{
    ...
    if (errNo == NO_ERROR)
    {
        ...
        if (bodydict == nil || [bodydict objectForKey:XML_GET_BUDDY_LIST_KEY] == nil)
            errNo = NECCESSARY_DATA_NOT_RETURNED;
        else{
            NSMutableDictionary *infodict = [bodydict objectForKey:XML_GET_BUDDY_LIST_KEY];
            ...
            {
                [Database deleteAllMatchedBuddies];
