...
- (void)configNavigation{
    self.navigationItem.rightBarButtonItem = [[[UIBarButtonItem alloc] initWithTitle:@"提交" style:UIBarButtonItemStylePlain target:self action:@selector(setHomework)] autorelease];
}
...
#pragma BL 2015.12.3
        //iPhone4时高度降低到60，否则键盘会覆盖_contentTextView
        if (IS_IOS4) {
            _contentTextView.height = 60;
        }else {
