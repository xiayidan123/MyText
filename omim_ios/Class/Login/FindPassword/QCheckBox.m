...
//        [self setImage:[UIImage imageNamed:@"checkbox1_checked.png"] forState:UIControlStateSelected];
        ...
        [self setTitle:@"显示密码" forState:UIControlStateNormal];
        [self setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
        [self.titleLabel setFont:[UIFont boldSystemFontOfSize:15.0f]];
        [self setImage:[UIImage imageNamed:@"btn_show_password_off"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"btn_show_password_on"] forState:UIControlStateSelected];
    }
    return self;
}
