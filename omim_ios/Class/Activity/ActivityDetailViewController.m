...
//                CGSize labelSize = [title sizeWithFont:[UIFont systemFontOfSize:15] constrainedToSize:CGSizeMake(150, 21)];
                ...
                CGSize size=CGSizeMake(150, 21);
                UIFont *font = [UIFont systemFontOfSize:15];
                NSDictionary *atttibutes=@{NSFontAttributeName:font};
                CGSize labelSize = [title boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:atttibutes context:nil].size;
