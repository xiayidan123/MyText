//
//  Communicator_GetMatchedBuddyList.m
//  omimLibrary
//
...
@implementation Communicator_GetMatchedBuddyList
...
- (void)wowtalkXMLParseFinished:(NSMutableDictionary *)result
{
    ...
    if (errNo == NO_ERROR)
    {
        ...
        {
            [Database deleteAllMatchedBuddies];   // TODO, problems. we can't delete all when we upload the contactbook. need to change here.
