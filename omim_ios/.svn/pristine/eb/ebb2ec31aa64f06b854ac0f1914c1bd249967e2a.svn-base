...
- (id)initWithParentView: (UIView *)_parentView
{
    ...
    if (self) {
        ...
        self.buttonTitles = [[NSArray alloc] init];
...
- (UIView *)createContainerView
{
    ...
    if (containerView == NULL) {
        ...
        if ([containerView viewWithTag:100] != NULL) {
            self.textFiled = (UITextField*)[containerView viewWithTag:100];
    ...
    // This is the dialog's container; we attach the custom content and the buttons to this one . TODO: we have to change the height to fit small screen and large screen
    UIView *dialogContainer = [[UIView alloc] initWithFrame:CGRectMake((screenWidth - dialogWidth) / 2, (screenHeight - dialogHeight) / 2 -offsetH, dialogWidth, dialogHeight)];
