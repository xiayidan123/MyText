//
//  TeacherModifyHomeworkVC.m
//  dev01
//
//  Created by Huan on 15/8/20.
...
#import "OMNetWork_MyClass.h"
@interface TeacherModifyHomeworkVC ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate,YBImagePickerViewControllerDelegate,YBImgePickerViewDelegate,OMAlertViewForNetDelegate,OMAlertViewForNetDelegate>
/** 照片选择*/
...
@implementation TeacherModifyHomeworkVC
...
#pragma mark setHomework - 上传作业 先删除再上传
...
//        OMViewController *vc = viewControllers[viewControllers.count - 2];
