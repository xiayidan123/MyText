...
- (void)didGetLessonList:(NSNotification *)notif{
    ...
    if (error.code == NO_ERROR) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            NSTimeInterval endTimeInterval = [NSDate ZeropointWihtTimeIntervalString:((Lesson *)lessonArr[i]).end_date];
            ...
            else if(_isSingln&&currentTimeInterval<endTimeInterval)
            {
                [self.dataArray addObject:lessonArr[i]];
            }
       }
