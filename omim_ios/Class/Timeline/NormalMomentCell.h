...
@interface NormalMomentCell : UITableViewCell<VoiceMessagePlayerDelegate,UITableViewDelegate,UITableViewDataSource,UIActionSheetDelegate,UIWebViewDelegate,UITextViewDelegate>
